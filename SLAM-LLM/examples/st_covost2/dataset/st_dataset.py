...
class SpeechDatasetJsonl(torch.utils.data.Dataset):
    ...
    def __init__(self,
        ...
        taslp_1 =  ['eng']
        taslp_28 = ['ara', 'ben', 'ces', 'deu', 'eng', 'fas', 'fra', 'heb', 'hin', 'ind', 'ita', 'jpn', 'khm', 'kor', 'lao', 'msa', 'mya', 'nld', 'pol', 'por', 'rus', 'spa', 'tha', 'tgl', 'tur', 'urd', 'vie', 'cmn']
        taslp_12 = ["cmn","eng","ara","ind","tur","tam","swh","tha","jpn","kor","hun","vie"]
        taslp_9 = ["cmn","eng","ara","ind","tur","tha","jpn","kor","vie"]
        taslp_67 = ['afr', 'ara', 'ast', 'bel', 'ben', 'bos', 'bul', 'cat', 'ceb', 'ces', 'cmn', 'cym', 'dan', 'deu', 'ell', 'est', 'fas', 'fin', 'fra', 'glg', 'guj', 'heb', 'hin', 'hrv', 'hun', 'hye', 'ind', 'isl', 'ita', 'jav', 'jpn', 'kan', 'kat', 'kaz', 'kor', 'lao', 'lav', 'lit', 'ltz', 'mal', 'mar', 'mkd', 'mlt', 'msa', 'nld', 'nob', 'npi', 'oci', 'pan', 'pol', 'por', 'ron', 'rus', 'slk', 'slv', 'spa', 'srp', 'swe', 'swh', 'tam', 'tel', 'tgl', 'tha', 'tur', 'ukr', 'urd', 'uzb', 'vie', 'yue', 'eng']
        taslp_71 = ['afr', 'amh', 'ara', 'asm', 'azj', 'bel', 'ben', 'bos', 'bul', 'cat', 'ces', 'cmn', 'cym', 'dan', 'deu', 'ell', 'eng', 'est', 'fas', 'fin', 'fra', 'glg', 'guj', 'heb', 'hin', 'hrv', 'hun', 'hye', 'ind', 'isl', 'ita', 'jav', 'jpn', 'kan', 'kat', 'kaz', 'khm', 'kir', 'kor', 'lao', 'lav', 'lit', 'mal', 'mkd', 'mon', 'msa', 'mya', 'nld', 'nob', 'npi', 'pan', 'pol', 'por', 'ron', 'rus', 'slk', 'slv', 'spa', 'srp', 'swe', 'swh', 'tam', 'tel', 'tgl', 'tha', 'tur', 'ukr', 'urd', 'uzb', 'vie', 'yue']
        # 设置随机种子，确保结果可复现
            ...
            with open(dataset_config.get("val_data_path"), encoding='utf-8') as fin:
                for line in fin:
                    ...
                    if self.source == data_source:
                        ...
                        if src_lang in taslp_12 and  tgt_lang in taslp_71:
                            if src_lang in taslp_9 and tgt_lang in taslp_67:
                                pass
                            else:
                                self.data_list.append(data_dict)
                    elif self.source == "6771":
                        if src_lang in taslp_71 and  tgt_lang in taslp_71:
                            if src_lang in taslp_12:
                                pass
                            elif src_lang in taslp_67 and tgt_lang in taslp_67:
                                pass
                            else:
                                self.data_list.append(data_dict)
                random.shuffle(self.data_list)  
